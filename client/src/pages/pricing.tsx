        ...
        <>
            <div className='w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]'>
                        ...
                        {plans.map((plan) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="w-full py-2 px-4 bg-indigo-500 hover:bg-indigo-600 active:scale-95
                ...
                <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'>
                    ...
                    <span className='text-white'> Credits</span>. You can purchase more credits to create more projects.
                </p>
